  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "Error",
          description: data.message || "Failed to create automation.",
          variant: "destructive",
        })
      }
    } catch (error) {
    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">Set up automated workflows and triggers</p>
        </div>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Optional JSON conditions for more specific triggers
              </p>
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Notification message template. Use {{variableName}} for dynamic content."
                rows={4}
              />
            </div>
